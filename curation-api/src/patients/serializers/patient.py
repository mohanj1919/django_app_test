...
from ..serializers.encounter import EncounterSerializer, EncounterRetrieveSerializer, EncounterDataSerializer
...
class PatientSerializer(serializers.ModelSerializer):
    encounters = EncounterSerializer(many=True, required=False)
    ...
    def create(self, validated_data):
        encounters = validated_data.pop('encounters', None)
        demographics = validated_data.pop('demographics', None)
    ...
    def getPatientEncounters(self, patient_id, cohort_id):
        ...
        return EncounterDataSerializer(encounters, many=True).data
...
class PatientRetrieveSerializer(serializers.ModelSerializer):
    ...
    def get_year_of_birth(self, instance):
        return str(instance.date_of_birth)

    def get_encounters(self, instance):
        encounters = Encounter.objects.filter(
            is_active=True,
            patient_id=instance.id)
        serializer = EncounterDataSerializer(encounters, many=True)
