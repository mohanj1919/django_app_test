...
VALUES (
    ...
    1,
    'welcome_email',
    'Welcome to OM1 curation application Email Template',
    '<h1><strong>Welcome {{name}},</strong></h1><p><a href="{{action_url}}" target="_blank" style="color: rgb(17, 85, 204);">Set your password</a><span style="color: rgb(80, 0, 80);">&nbsp;to activate your OM1 Curation user account.</span><strong><br>
    ...
    'Reset Password for OM1 application', '<h1><strong>Hi {{name}},</strong></h1><p>This&nbsp;password&nbsp;reset&nbsp;is only valid for the next 24 hours.</p><p><br></p><ol><li><a href="{{action_url}}" target="_blank" style="color: rgb(17, 85, 204);">Reset&nbsp;your&nbsp;password</a><strong style="color: rgb(34, 34, 34);"><br>
