export default {
  api: {
    ...
    get_completed_project_chart_reviews: '/clinical/chartreview/get_completed_project_chart_reviews/',
    ...
    get_chart_review_response: '/clinical/chartreview/get_chart_review_response/'
  },
  HTTP_Status: {
    success: '200',
    UNAUTHORIZE: '401',
