              ...
              : <div>
                {_.isEmpty(q.annotation_text) && _.isEmpty(_.find(q.options, { selected: true }))
                  ...
                  : <div className='col-md-8'>
                    ...
                    {!_.isEmpty(q.options)
                      ? <div><label>Select Encounters on Date: </label> <Multiselect data={q.options} name='annotationOption' multiple
                        onChange={(e) => context.props.optionsChanged(e, q.id, q.question_id, 'encounterDates') } /></div> : null
                    }
                  </div>
                }
                <div className='col-md-4'>
                  {q.note
                    ? <OverlayTrigger trigger={['hover', 'focus']} placement='top' overlay={
                      ...
                      <h5 className='text-info help-text pull-right'>Help&nbsp; <i className='fa fa-question-circle-o' /></h5>
                    </OverlayTrigger> : null}
                </div>
              </div>
            }
