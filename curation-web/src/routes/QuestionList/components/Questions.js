...
import { Button, InputGroup, Modal, FormControl, ControlLabel, FormGroup, HelpBlock } from 'react-bootstrap'
      ...
      return (
        <InputGroup className='search-questions table-search-box'>
          <input type='text' placeholder='Search Questions'
            onChange={(e) => this.props.SearchQuestion(e)} className='form-control' />
        ...
        <div className='questions-container'>
          <div className='container'>
            <BootstrapTable
              ...
              options={options}
              remote>
              <TableHeaderColumn dataFormat={tableCell} dataField='text' dataSort isKey>Question Text</TableHeaderColumn>
              <TableHeaderColumn dataFormat={typeCell} dataField='type' dataSort>Question Type</TableHeaderColumn>
              <TableHeaderColumn dataFormat={tableCell} dataField='description' dataSort>Description</TableHeaderColumn>
              <TableHeaderColumn dataFormat={tableCell} dataField='responses' dataSort>Responses</TableHeaderColumn>
                          ...
                          <div className='question-options'>
                            {this.props.selectedObject && this.props.selectedObject && this.props.selectedObject.responses && this.props.selectedObject.responses.value
                                        ? this.props.selectedObject.responses.value.map((res, i) => (
                                          <span key={i}><label>{res}</label><i className='fa fa-trash-o' onClick={() => this.props.RemoveOption(i)} /><br /></span>
                                        )) : null
                                    }
                            ...
                            {!this.props.selectedObject && this.props.newQuestion && this.props.newQuestion.responses && this.props.newQuestion.responses.value
                                        ? this.props.newQuestion.responses.value.map((qo, i) => (
                                          <span key={i}><label>{qo}</label><i className='fa fa-trash-o' onClick={() => this.props.RemoveOption(i)} /><br /></span>
                                        )) : null
                                    }
                          </div>
                        </form>
