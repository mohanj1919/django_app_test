          ...
          <div className='row'>
            {localStorage.getItem('logged_user_role') !== 'curator'
                    ? <div className='col-md-12'>
                      ...
                      <Button bsStyle='link' className='pull-right' onClick={() => { window.location.href = '/search/download_by_template' }}>Download By Template</Button>
                      <br />
                    </div> : null}
            <div className='col-md-12'>
              <BootstrapTable
                ...
                pagination
                remote>
                <TableHeaderColumn dataField='patient_id' isKey dataSort>Patient Id</TableHeaderColumn>
                <TableHeaderColumn dataFormat={tableCell} dataField='project_name' dataSort>Project Name</TableHeaderColumn>
                <TableHeaderColumn dataFormat={tableCell} dataField='cohort_name' dataSort>Cohort Name</TableHeaderColumn>
                <TableHeaderColumn dataFormat={tableCell} dataField='curator_email' dataSort>Curator</TableHeaderColumn>
