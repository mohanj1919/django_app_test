      ...
      <div className='container users-list'>
        ...
        {this.props && this.props.users
          ? <BootstrapTable
            ...
            pagination
            remote>
            <TableHeaderColumn dataFormat={tableCell} dataField='first_name' dataSort>First Name</TableHeaderColumn>
            <TableHeaderColumn dataFormat={tableCell} dataField='last_name' dataSort>Last Name</TableHeaderColumn>
            <TableHeaderColumn dataFormat={tableCell} dataField='email' isKey dataSort>Email</TableHeaderColumn>
            <TableHeaderColumn dataFormat={tableCell} dataField='phone_number' dataSort>Mobile number</TableHeaderColumn>
            <TableHeaderColumn dataFormat={displayRole} dataField={'groups__name'} dataSort>Role</TableHeaderColumn>
            <TableHeaderColumn dataFormat={userStatusSwitch}>Status</TableHeaderColumn>
            <TableHeaderColumn dataFormat={MfaTypeTableCell} dataField='mfa_type' dataSort>MFA type</TableHeaderColumn>
                ...
                <div>
                  <form>
                    ...
                    {this.props.selectedObject.id
                      ? <FormGroup>
                        <ControlLabel>Account Locked</ControlLabel>
                        <ButtonToolbar>
                        <ToggleButtonGroup type='radio' name='options' defaultValue={this.props.selectedObject.is_account_locked}
                           ...
                           <ToggleButton value={false}>True</ToggleButton>
          ...
          : (
            <Modal dialogClassName='modal-sm' className='normal-modal' show={this.props.showModal} onHide={this.props.toggleModal}>
              <Modal.Header closeButton>
                ...
                <label>{this.props.selectedObject ? 'email ' + this.props.selectedObject.email : null}</label > </Modal.Body> <Modal.Footer > <Button type='submit' bsStyle='danger' onClick={() => this.props.DeleteUser()}>
                  Delete
                </Button> </Modal.Footer>
            </Modal >)
        } </div>
